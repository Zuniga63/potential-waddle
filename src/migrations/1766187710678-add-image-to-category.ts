...
export class AddImageToCategory1766187710678 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "category" ADD CONSTRAINT "FK_df45b0f8aeef3e3d29b1a277b62" FOREIGN KEY ("image_resource_id") REFERENCES "image_resource"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }
