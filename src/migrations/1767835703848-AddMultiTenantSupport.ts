...
export class AddMultiTenantSupport1767835703848 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user_towns" ("usersId" uuid NOT NULL, "townId" uuid NOT NULL, CONSTRAINT "PK_74f7dfefca62e21960df0e34ec2" PRIMARY KEY ("usersId", "townId"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "user_towns" ADD CONSTRAINT "FK_db95579d35ccde77992250ab0fa" FOREIGN KEY ("usersId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_towns" ADD CONSTRAINT "FK_6777bfe6a5febf097021ca53de8" FOREIGN KEY ("townId") REFERENCES "town"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
