...
export class AddExperiencePriceLabelAndAdditionalPrices1769100000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "experience" ADD "price_label" text NOT NULL DEFAULT 'Persona'`);
    await queryRunner.query(`ALTER TABLE "experience" ADD "additional_prices" jsonb NOT NULL DEFAULT '[]'`);
  }
