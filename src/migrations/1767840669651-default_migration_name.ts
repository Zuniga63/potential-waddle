...
export class DefaultMigrationName1767840669651 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "guide_town" ("guide_id" uuid NOT NULL, "town_id" uuid NOT NULL, CONSTRAINT "PK_064470121573572e8c1b7a904ff" PRIMARY KEY ("guide_id", "town_id"))`,
    );
    ...
    await queryRunner.query(
      `INSERT INTO "guide_town" ("guide_id", "town_id") SELECT "id", "town_id" FROM "guide" WHERE "town_id" IS NOT NULL`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "guide_town" ADD CONSTRAINT "FK_a8c0dbc17ab28e8a6148f361a20" FOREIGN KEY ("guide_id") REFERENCES "guide"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "guide_town" ADD CONSTRAINT "FK_82b71a9861142b24f157049c124" FOREIGN KEY ("town_id") REFERENCES "town"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
